...
Usage:
    ...
    python repro/interspeech2026_rebuttal/export_voicebank_test.py --n -1 --dest /tmp/vb_full
    # First 5 pairs (smoke test):
    python repro/interspeech2026_rebuttal/export_voicebank_test.py --n 5 --dest /tmp/vb_smoketest
"""
